...
![Has AI killing collaboration?](/assets/images/2026/May25-banner.png)
...
If the majority of my work is with an AI prompt, doesn't that make it easier to work asynchronously? Organizations are also requiring AI usage as a lever to increase productivity, yet [research has shown that employees are just as or more productive when working remotely](https://www.nber.org/papers/w30292).
