...
Let's start providing remedies for the list of deficiencies that I mentioned in [my last article](/posts/2024/2024-09-26-aspire-keycloak-part1.html).  First up, I wanted to ensure logins were handled via a secure HTTPS request.  The following line in the Dockerfile is of interest:
