...
Over the past three articles, I've covered a lot of the ins and outs of a typical Azure Mobile Apps service.  I've covered [scaffolding](/posts/2021/2021-11-08-azure-mobile-apps-intro.html), [authentication](/posts/2021/2021-11-09-adding-auth-to-zumo.html), and [complex authorization](/posts/2021/2021-11-10-complex-zumo-auth.html).  There are just a few more topics to cover on the basic cases.
