...
Recently, I posted an article on the [AI Maturity Model](/posts/2026/2026-04-03-ai-discussion.html).  In that article, I proposed six stages of growth - from tactician or accidental editor to the agentic engineer.  The biggest difference between the vibe coder and the agentic engineer is the transition to spec-driven design.
...
![The three pillars of agentic engineering](/assets/images/2026/Apr07-agentic-engineer-1.png)
...
This is so important that I'm going to [follow up on this topic in a future article](/posts/2026/2026-04-09-agentic-engineer-2.html).
