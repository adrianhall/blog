...
![Where the policy links are](/assets/images/2021/2021-06-11-image1.png)
...
1. Select the **Add policy** in the **Inbound processing** section:
   ...
   ![Add a policy](/assets/images/2021/2021-06-11-image2.png)

1. Press **Cache responses**.

   ![Cache responses](/assets/images/2021/2021-06-11-image3.png)
...
1. Fill in the form:
   ...
   ![Set up the caching](/assets/images/2021/2021-06-11-image4.png)
...
1. In the **Outbound processing**, select the policy editor:
   ...
   ![Access the policy editor](/assets/images/2021/2021-06-11-image5.png)
