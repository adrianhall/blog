...
You may have noticed that I included ASP.NET Identity in a project [a couple of posts ago](/posts/2024/2024-09-05-aspire-identity.html).  I'm currently doing a deep dive into ASP.NET Identity with an eye towards an OIDC identity service based on [OpenIddict](https://documentation.openiddict.com/).
...
For this project, I'm going to use a PostgreSQL database and Entity Framework Core.  You may have caught onto this if you read [my earlier article on Aspire](/posts/2024/2024-09-05-aspire-identity.html). With Aspire, I can set up the database and the identity service as containers and run them on Docker Desktop.
