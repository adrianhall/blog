...
* [The basics - a username/password system](/posts/2018/2018-09-18-auth-with-aws-amplify-1.html).
* [Customizing the UI](/posts/2018/2018-09-23-auth-with-aws-amplify-2.html).
* [Authenticating with Facebook](/posts/2018/2018-10-01-auth-with-aws-amplify-3.html).
* [Authenticating with Google](/posts/2018/2018-10-08-auth-with-aws-amplify-4.html).
* [Using third-party authentication providers](/posts/2018/2018-10-15-auth-with-aws-amplify-5.html).
* [Using Time-based One-time passwords (TOTP)](/posts/2018/2018-10-22-auth-with-aws-amplify-6.html).
* [Using Biometric authentication](/posts/2018/2018-10-29-auth-with-aws-amplify-7.html).
* [Doing fraud protection and analytics](/posts/2018/2018-11-05-auth-with-aws-amplify-8.html).
...
In [the previous article](/posts/2018/2018-09-18-auth-with-aws-amplify-1.html), I introduced you to the basics of setting up an authentication UI with username and password by integrating a simple (provided) UI with a component called `IdentityManager` from the AWS Mobile SDK to provide the authentication screens. It's nice and simple. 
...
![](/assets/images/2018/2018-09-23-image1.png)
...
![](/assets/images/2018/2018-09-23-image2.png)
...
![](/assets/images/2018/2018-09-23-image3.png)
