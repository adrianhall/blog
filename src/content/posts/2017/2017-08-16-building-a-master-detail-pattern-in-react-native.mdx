...
* [Worked out how to handle orientation changes](/posts/2017/2017-07-26-handling-orientation-changes-in-react-native.html).
* [Worked out how to implement swipe-to-delete](/posts/2017/2017-08-07-implementing-swipe-right-on-a-react-native-flatlist.html).
* [Figured out the best way to use TypeScript](/posts/2017/2017-08-09-debugging-react-native-with-typescript-and-vscode.html).
* [Integrated MobX for the Flux pattern](/posts/2017/2017-08-11-integrating-react-native-typescript-mobx.html).
* [Fixed up the project for universal iOS apps](/posts/2017/2017-08-14-universal-ios-apps-with-react-native.html).
...
The next set of methods determine if the interface should be in two-pane mode or not. These are taken directly from my work on [detecting orientation changes](/posts/2017/2017-07-26-handling-orientation-changes-in-react-native.html).
