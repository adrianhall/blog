...
In the last two articles, I've gone over how you can [create a basic datasync service](/posts/2021/2021-11-08-azure-mobile-apps-intro.html) and [add authentication](/posts/2021/2021-11-09-adding-auth-to-zumo.html) to the service.  What if you want to do something more complex?  Authorization that is an on/off switch is reasonable as a first pass, but rarely allows you to handle the cases you actually need to implement.
