...
Todays topic is "how do I upgrade the service backend to support the new ASP.NET Core service without affecting my current customers?"  Let's assume, for a moment, that I have already [created an API Management service](/posts/2021/2021-06-08-using-apim-with-zumo.html), and [added caching](/posts/2021/2021-06-11-adding-policies-to-apim.html) to my API.  Finally, I've adjusted the client application so everything is routing through the API Management service instead of direct to the backend.
...
1. Open the policy editor for your API.
   ...
   ![Open the policy editor](/assets/images/2021/2021-06-15-image1.png)
...
![Two versions listed](/assets/images/2021/2021-06-15-image2.png)
...
![Two revisions listed](/assets/images/2021/2021-06-15-image3.png)
