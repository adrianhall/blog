...
This article will be in three parts.  This part will cover the the server code.  The [next part](/posts/2022/2022-09-02-blazor-wasm-aad-auth-part-2.html) will cover the client code.  Finally, I'll take a look at what it takes to convert the basic code for flexible use across development to staging and production.
...
![Screenshot to show registering an application](/assets/images/2022/09-01/image1.png)
...
![Screenshot showing the registered application](/assets/images/2022/09-01/image2.png)
...
![Screenshot to show registering an application](/assets/images/2022/09-01/image3.png)
...
The client piece is covered in the [next blog post](/posts/2022/2022-09-02-blazor-wasm-aad-auth-part-2.html). Until then, happy coding!
