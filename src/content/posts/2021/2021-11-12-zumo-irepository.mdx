...
Over the last four days, I've delved into how to build a data sync service using Azure Mobile Apps on ASP.NET Core 6.  I've covered [the template](/posts/2021/2021-11-08-azure-mobile-apps-intro.html), [authentication](/posts/2021/2021-11-09-adding-auth-to-zumo.html), [authorization](/posts/2021/2021-11-10-complex-zumo-auth.html), and [logging](/posts/2021/2021-11-11-logging-with-zumo.html).  The basic setup is really good when you have a 1:1 relationship between the table and the DTO and you don't need to do anything special, like support a non-EF Core ORM, or integrate real-time alerting.  There are all sorts of reasons you don't want to use the standard repository.
